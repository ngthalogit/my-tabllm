...
template_config_kc2 = {
    'pre': {
        'loc': lambda x: f"{x:.1f}",
        'v_g': lambda x: f"{x:.1f}",
        'ev_g': lambda x: f"{x:.1f}",
        'iv_g': lambda x: f"{x:.1f}",
        'n': lambda x: f"{x:.1f}",
        'v': lambda x: f"{x:.2f}",
        'l': lambda x: f"{x:.2f}",
        'd': lambda x: f"{x:.2f}",
        ...
        'b': lambda x: f"{x:.2f}",
        't': lambda x: f"{x:.2f}",
        'lOCode': lambda x: f"{x:.1f}",
        'lOComment': lambda x: f"{x:.1f}",
        'lOBlank': lambda x: f"{x:.1f}",
        'lOCodeAndComment': lambda x: f"{x:.1f}",
        'uniq_Op': lambda x: f"{x:.1f}",
        'uniq_Opnd': lambda x: f"{x:.1f}",
        'total_Op': lambda x: f"{x:.1f}",
        'total_Opnd': lambda x: f"{x:.1f}",
        'branchCount': lambda x: f"{x:.1f}"
    }
}
template_kc2 = "The percentage of McCabe's line count of code is ${loc}. " \
                    'The percentage of McCabe "cyclomatic complexity" is ${v_g}. '  \
                    'The percentage of McCabe "essential complexity" is ${ev_g}. ' \
                    'The percentage of McCabe "design complexity" is ${iv_g}. ' \
                    'The percentage of Halstead total operators and operands is ${n}. ' \
                    'The percentage of Halstead "volume" is ${v}. ' \
                    'The percentage of Halstead "program length" is ${l}. ' \
                    'The percentage of Halstead "difficulty" is ${d}. ' \
                    'The percentage of Halstead "intelligence" is ${i}. ' \
                    'The percentage of Halstead "effort" is ${e}. ' \
                    'The percentage of Halstead is ${b}. ' \
                    "The percentage of Halstead's time estimator is ${t}. " \
                    "The percentage of Halstead's line count is ${lOCode}. " \
                    "The percentage of Halstead's count of lines of comments is ${lOComment}. " \
                    "The percentage of Halstead's count of count of blank lines is ${lOBlank}. " \
                    "The percentage of Halstead's count of lines of code and comments is ${lOCodeAndComment}. " \
                    "The percentage of unique operators is ${uniq_Op}. " \
                    "The percentage of unique operands is ${uniq_Opnd}. " \
                    "The percentage of total operators is ${total_Op}. " \
                    "The percentage of total operands is ${total_Opnd}. " \
                    'The percentage of the flow graph is ${branchCount}.'
template_config_kc2_list = template_config_kc2
template_kc2_list = "- McCabe's line count of code: ${loc}\n" \
                         '- McCabe "cyclomatic complexity": ${v_g}\n' \
                         '- McCabe "essential complexity: ${ev_g}\n' \
                         '- McCabe "design complexity: ${iv_g}\n' \
                         ...
                         "- Halstead's count of count of blank lines: ${lOBlank}\n" \
                         "- Halstead's count of lines of code and comments: ${lOCodeAndComment}\n" \
                         "- Halstead's unique operators: ${uniq_Op}\n" \
                         "- Halstead's unique operands: ${uniq_Opnd}\n" \
                         "- Halstead's total operators: ${total_Op}\n" \
...
template_kc2_list_values = "${loc}\n" \
                         ...
                         "${total_Opnd}\n" \
                         '${branchCount}'
template_config_kc2_list_values = template_config_kc2_list
template_kc2_list_shuffled = template_kc2_list
template_config_kc2_list_shuffled = template_config_kc2_list
